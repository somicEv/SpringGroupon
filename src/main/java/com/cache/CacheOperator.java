...
public abstract class CacheOperator {
	 ...
	 * @param entity
	 */
	protected <T extends Object> void putEntity(String key, T entity) {
	 ...
	 * @param entities
	 */
	protected <T extends Object> void putEntities(String key, List<T> entities) {
		if (null != this.getJedis()) {
	 ...
	 * @param cacheObject
	 */
	protected <T extends Object> void putCacheObject(String key, T cacheObject) {
		if (null != this.getJedis()) {
	 ...
	 * @return
	 */
	protected <T extends Object> T getEntity(String key, Class<T> clazz) {
		if (null != this.getJedis()) {
	 ...
	 * @return
	 */
	protected <T extends Object> T getCacheObject(String key, Class<T> clazz) {
		if (null != this.getJedis()) {
			byte[] bytes = this.getJedis().get(key.getBytes());
			if (null == bytes) {
				return null;
	 ...
	 * @return
	 */
	protected <T extends Object> List<T> getEntities(String key, Class<T> clazz) {
		try {
			if (null != this.getJedis()) {
				byte[] bytes = this.getJedis().get(key.getBytes());
				if (null == bytes) {
	 ...
	 * @return
	 */
	protected <T extends Object> List<T> getEntitiesByKeyPrefix(String keyPrefix, Class<T> clazz) {
		if (null != this.getJedis()) {
	 ...
	 * @return
	 */
	protected <T extends Object> List<T> getCacheObjectsByKeyPrefix(String keyPrefix, Class<T> clazz) {
		if (null != this.getJedis()) {

    ...
    <body>
        ...
        <div class="shoppingCart comWidth">
                ...
                <div class="shopping_item">
                    ...
                    <div class="shopping_cont padding_shop">
                        <ul class="shopping_list">
                            <li><input type="radio" name="payType" value="1" class="radio" id="r1"><label for="r1">微信支付</label></li>
                            <li><input type="radio" name="payType" value="2" class="radio" id="r2"><label for="r2">支付宝支付</label></li>
                            <li><input type="radio" name="payType" value="3" class="radio" id="r3"><label for="r3">货到付款</label></li>
                        </ul>
                    </div>
                </div>
                <div class="hr_25"></div>

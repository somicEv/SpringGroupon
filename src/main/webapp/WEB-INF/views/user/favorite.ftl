...
<head>
    ...
    <script>
        ...
        function deleteFavorite(skuId) {
        <#if username?? >
            Submit.AjaxSubmit('${ctx}/home/favorite/delete/' + skuId);
        <#else>
            window.location = '${ctx}/login';
        </#if>
        }
                    ...
                    <#list favorites as favorite>
                        <div class="cart_cont clearfix">
                            <div class="cart_item t_name">
                                <div class="cart_shopInfo clearfix">
                                    ...
                                    <#--<input type="checkbox" id="${favorite.favorite.id}" onclick="check(this, ${favorite.favorite.id})" style="float:left; margin-top:40px; margin-right: 10px">-->
                                        <img src="${ctx}/${helper.getDealImageUrlForIndexDealList(favorite.deal)}"
                                             alt="">
                            ...
                            <div class="cart_item t_operate">
                                <#if favorite.deal.start>
                                    <a href="#" onclick="addToCart(${favorite.deal.skuId})" class="btn_link">购买&nbsp;&nbsp;</a>
                                <#else>
                                    <a href="${ctx}/item/${favorite.deal.skuId}" class="btn_link" onclick="">查看&nbsp;&nbsp;</a>
                                </#if>
                                <a href="#" onclick="deleteFavorite(${favorite.deal.skuId})" class="btn_link">删除</a>
                            </div>
                        </div>
                    </#list>
                <#else >

    ...
    <div class="rightArea">
        ...
        <#else>
            <form method="post" id="info_form" action="/home/info/add">
                <tr>
                    <td style="width: 20%">昵称：</td>
                    <td><input type="text" id="nickname" name="nickname" class="big_input"
                               style="background-color: #BFBFBF" disabled></td>
                </tr>
                <tr>
                    <td>邮箱：</td>
                    <td><input type="text" id="mail" name="mail" class="big_input" style="background-color: #BFBFBF"
                               disabled></td>
                </tr>
                <tr>
                    <td>联系电话：</td>
                    <td><input type="text" id="phone" name="phone" class="big_input" style="background-color: #BFBFBF"
                               disabled></td>
                </tr>
                <tr>
                    <td>真实姓名：</td>
                    <td><input type="text" id="realName" name="realName" class="big_input"
                               style="background-color: #BFBFBF" disabled></td>
                </tr>
                <tr>
                    <td align="center" colspan="2"><input type="button" onclick="modify()" value="修改"
                                                          class="btn"/><input type="button" onclick="addInfo()"
                                                                              value="提交" class="btn"/></td>
                </tr>
            </form>
        </#if>
